...
@section('content')
     ...
     <div class="container">
           <div class="header-title margin-bt-2">
            <div class="row">
                  <div class="header col-sm-6" style="border-bottom: none;">NEET-HALL TICKET</div>
                  <div class="col-sm-6">
                       <a href="{{route('neet-change-input')}}">
            ...
            <div class="card-body">
                <form action="{{ route('neet-import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
