...
<style type="text/css">
    ...
    <div class="container">
              <div class="header-title margin-bt-2">
                    <div class="header" style="border-bottom: none;">JEE EXAMS LIST</div>
                    <a href="{{route('jee-exam-name')}}"><button class="btn btn-dark" style="float: right;margin-top: 2px;">ADD EXAMS</button></a>
                ...
                <table class="table" id="datatable">
                 ...
                 <tr>
                  <th scope="row">{{$i}}</td>
                        ...
                        @if($data->status==0)
                        <td><a href="{{url('jee_exam_delete')}}/{{$data->id}}">
