...
<style type="text/css">
    ...
    <div class="container">
              <div class="header-title margin-bt-2">
                    <div class="header" style="border-bottom: none;">TNPSC EXAMS LIST</div>
                    <a href="{{route('tnpsc-exam-name')}}"><button class="btn btn-primary" style="float: right;margin-top: 2px;">ADD EXAMS</button></a>
                ...
                <table class="table" id="datatable">
                  ...
                  @foreach($exams as $data)
                   <tr>
                        ...
                        @if($data->status==0)
                        <td><a href="{{url('exam_delete')}}/{{$data->id}}">
