...
<div class="container">
    <div class="header-title margin-bt-2">
        <div class="header" style="border-bottom: none;">CA/CMA Result - {{$active_exam->exam_name}}</div>
    </div>
    <div style="width:60%;margin-left: 20%;text-align: center;"> 
        <form method="POST" action="{{ route('ca-mark-view') }}">
            {{csrf_field()}}
                ...
                <button id="ok" type="submit" class="text-center mt-3 text-white btn btn-danger form-control" style="width:30%">GET MARKS</button>
        </form>
   </div>
</div>
